...
namespace BoardGames.Migrations
{
    ...
    [Migration("20201029084807_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoardGames.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BoardGames.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BoardGames.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("BoardGames.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("BoardGames.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("BoardGames.Authorization.Roles.Role", b =>
                {
                    b.HasOne("BoardGames.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("BoardGames.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("BoardGames.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
