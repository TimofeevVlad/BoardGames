...
{
    public abstract class BoardGamesWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BoardGamesWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BoardGamesWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BoardGamesDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BoardGamesDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BoardGamesDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BoardGamesDbContext, Task<T>> func)
        {
            T result;
